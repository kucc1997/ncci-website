							...
							<div className="space-y-4">
								...
								<Card>
									...
									<CardContent>
										...
										<p className="text-gray-700">
											Welcome address by the Dean of School of Engineering,
											followed by the lighting of the lamp and inaugural
											speeches.
										</p>
									</CardContent>
								</Card>
								...
								<Card>
									<CardHeader className="pb-2">
										<div className="flex justify-between items-start">
											<div>
												<CardTitle>
													Keynote: The Future of AI: Opportunities and
													Challenges
												</CardTitle>
									...
									<CardContent>
										...
										<p className="text-gray-700">
											An exploration of the current state and future directions
											of artificial intelligence, including ethical
											considerations, technological advancements, and potential
											societal impacts.
										</p>
									</CardContent>
								</Card>
								...
								<Card>
									...
									<CardContent>
										...
										<p className="text-gray-700">
											Take a break, enjoy refreshments, and network with fellow
								...
								<Card>
									...
									<CardContent>
										...
										<p className="text-gray-700">
											...
											encryption methods and the development of
							...
							<div className="space-y-4">
								<Card>
									<CardHeader className="pb-2">
										<div className="flex justify-between items-start">
											<div>
												<CardTitle>
													Panel Discussion: Cybersecurity Challenges in the
													Digital Age
												</CardTitle>
									...
									<CardContent>
										...
										<p className="text-gray-700">
											A panel of cybersecurity experts discuss current threats,
											defense strategies, and the evolving landscape of digital
											security.
										</p>
									</CardContent>
								</Card>
								...
								<Card>
									...
									<CardContent>
										...
										<p className="text-gray-700">
											Enjoy refreshments while exploring poster presentations by
								...
								<Card>
									<CardHeader className="pb-2">
										<div className="flex justify-between items-start">
											<div>
												<CardTitle>
													Keynote: Big Data Analytics: Extracting Value from
													Data
												</CardTitle>
									...
									<CardContent>
										...
										<p className="text-gray-700">
											A deep dive into the world of big data analytics,
											exploring techniques for data processing, analysis, and
											visualization to derive meaningful insights.
										</p>
									</CardContent>
								</Card>
								...
								<Card>
									<CardHeader className="pb-2">
										<div className="flex justify-between items-start">
											<div>
												<CardTitle>
													Panel Discussion: Innovation and Entrepreneurship in
													Tech
												</CardTitle>
				...
				<TabsContent value="papers">
					<div className="space-y-4">
						<div className="bg-gray-50 p-4 rounded-lg mb-6">
							...
							<p className="text-gray-700">
								Paper presentations are organized into parallel tracks. Each
								presenter will have 15 minutes for their presentation, followed
								by 5 minutes for questions and discussion.
							</p>
						</div>
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												1:00 PM - 1:20 PM | Presenter: Amit Patel, IIT Delhi
											</CardDescription>
										</div>
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												1:20 PM - 1:40 PM | Presenter: Dr. Sophia Lee, National
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												1:40 PM - 2:00 PM | Presenter: Prof. Robert Chen,
						...
						<h3 className="font-semibold text-lg mb-3">
							Track 2: Cybersecurity and Privacy (Room 102)
						</h3>
						<div className="space-y-3 mb-6">
							<Card>
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												1:00 PM - 1:20 PM | Presenter: Dr. James Wilson, ETH
												Zurich
											</CardDescription>
										</div>
										<Badge className="bg-red-100 text-red-800 hover:bg-red-200">
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												1:20 PM - 1:40 PM | Presenter: Dr. Elena Martinez, MIT
											</CardDescription>
										</div>
										<Badge className="bg-red-100 text-red-800 hover:bg-red-200">
											Paper
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												1:40 PM - 2:00 PM | Presenter: Rahul Sharma, Kathmandu
												University
											</CardDescription>
										</div>
										<Badge className="bg-red-100 text-red-800 hover:bg-red-200">
						...
						<h3 className="font-semibold text-lg mb-3">
							Track 3: Cloud Computing and Distributed Systems (Room 103)
						</h3>
						<div className="space-y-3 mb-6">
							<Card>
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											<CardTitle className="text-base">
												Serverless Computing: Challenges and Opportunities
											</CardTitle>
											<CardDescription>
												3:30 PM - 3:50 PM | Presenter: Dr. Michael Brown, AWS
											</CardDescription>
										</div>
										<Badge className="bg-red-100 text-red-800 hover:bg-red-200">
											Paper
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												3:50 PM - 4:10 PM | Presenter: Dr. Lisa Wang, Microsoft
												Research
											</CardDescription>
										</div>
										<Badge className="bg-red-100 text-red-800 hover:bg-red-200">
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												4:10 PM - 4:30 PM | Presenter: Prof. David Kim, Stanford
												University
											</CardDescription>
										</div>
										<Badge className="bg-red-100 text-red-800 hover:bg-red-200">
						...
						<h3 className="font-semibold text-lg mb-3">
							Track 4: Internet of Things and Smart Systems (Room 104)
						</h3>
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												3:30 PM - 3:50 PM | Presenter: Dr. Anita Patel,
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												3:50 PM - 4:10 PM | Presenter: Priya Sharma, IIT Bombay
											</CardDescription>
										</div>
										<Badge className="bg-red-100 text-red-800 hover:bg-red-200">
											Paper
								...
								<CardHeader className="py-3">
									<div className="flex justify-between items-start">
										<div>
											...
											<CardDescription>
												4:10 PM - 4:30 PM | Presenter: Dr. Thomas Wilson, IBM
												Research
											</CardDescription>
										</div>
										<Badge className="bg-red-100 text-red-800 hover:bg-red-200">

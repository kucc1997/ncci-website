    ...
    <div className="container px-4 md:px-6 py-12">
      <div className="flex flex-col items-center text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-3xl">
          Learn about the National Conference on Computer Innovations, its objectives, and significance in the field of
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
        <div>
          ...
          <p className="text-gray-700 mb-4">
            The National Conference on Computer Innovations (NCCI) is a premier academic event that brings together
            researchers, industry professionals, and students to share knowledge, present research findings, and discuss
            emerging trends in computer science and technology.
          </p>
          <p className="text-gray-700 mb-4">
            Hosted by Kathmandu University Computer Club (KUCC) in collaboration with the Department of Computer Science
            and Engineering (DoCSE), NCCI 2025 aims to foster innovation, collaboration, and knowledge exchange in the
            rapidly evolving field of computer science.
          </p>
          <p className="text-gray-700">
            The conference provides a platform for participants to network with peers, engage with industry leaders, and
            gain insights into cutting-edge research and technological advancements.
          </p>
        </div>
        <div className="relative h-[300px] md:h-[400px] rounded-lg overflow-hidden shadow-lg">
          <Image src="/placeholder.svg?height=800&width=1200" alt="Conference Hall" fill className="object-cover" />
        </div>
      </div>

      <div className="bg-gray-50 p-8 rounded-xl mb-16">
        <h2 className="text-2xl font-bold mb-6 text-center">Conference Objectives</h2>
      ...
      <div className="bg-blue-700 text-white p-8 md:p-12 rounded-xl text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-4">Join Us at NCCI 2025</h2>
        <p className="text-lg text-white/90 max-w-2xl mx-auto mb-8">
          Be part of this exciting event and contribute to the advancement of computer science and technology in Nepal
          and beyond.
        </p>

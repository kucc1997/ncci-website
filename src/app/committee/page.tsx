  ...
  return (
    <div className="container px-4 md:px-6 py-12">
      <div className="flex flex-col items-center text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">Organizing Committee</h1>
      ...
      {/* Advisory Committee */}
      <div className="mb-16">
        <h2 className="text-2xl font-bold mb-8 text-center">Advisory Committee</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
          {[
            { name: "Dr. Jane Smith", position: "Head, DoCSE", affiliation: "Kathmandu University" },
            { name: "Prof. Robert Johnson", position: "Professor", affiliation: "Kathmandu University" },
            { name: "Dr. Emily Brown", position: "Associate Professor", affiliation: "Kathmandu University" },
            { name: "Prof. Michael Wilson", position: "Professor", affiliation: "Kathmandu University" },
          ].map((member, index) => (
      ...
      <div className="mb-16">
        <h2 className="text-2xl font-bold mb-8 text-center">Organizing Committee</h2>

        {/* Conference Chair */}
        <div className="mb-12">
          <h3 className="text-xl font-semibold mb-6 text-center">Conference Chair</h3>
          <div className="flex justify-center">
            <div className="text-center max-w-xs">
        ...
        <div className="mb-12">
          <h3 className="text-xl font-semibold mb-6 text-center">Technical Program Committee</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
            {[
              { name: "Dr. David Lee", position: "Committee Chair", affiliation: "Kathmandu University" },
              { name: "Prof. Lisa Wang", position: "Member", affiliation: "Kathmandu University" },
              { name: "Dr. Richard Chen", position: "Member", affiliation: "Kathmandu University" },
              { name: "Dr. Amanda Taylor", position: "Member", affiliation: "Kathmandu University" },
            ].map((member, index) => (
              <div key={index} className="text-center max-w-xs">
        ...
        <div className="mb-12">
          <h3 className="text-xl font-semibold mb-6 text-center">Publication Committee</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
            {[
              { name: "Dr. Thomas Brown", position: "Committee Chair", affiliation: "Kathmandu University" },
              { name: "Dr. Sophia Garcia", position: "Member", affiliation: "Kathmandu University" },
              { name: "Prof. James Wilson", position: "Member", affiliation: "Kathmandu University" },
              { name: "Dr. Olivia Martinez", position: "Member", affiliation: "Kathmandu University" },
            ].map((member, index) => (
              <div key={index} className="text-center max-w-xs">
                <div className="relative w-28 h-28 mx-auto mb-3 rounded-full overflow-hidden border-4 border-blue-100">
                  <Image
        ...
        {/* Student Volunteers */}
        <div>
          <h3 className="text-xl font-semibold mb-6 text-center">Student Volunteers (KUCC)</h3>

...
import { Calendar, MapPin, Users, FileText, Mic, Clock, Mail, ArrowRight } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-20 text-center px-4 md:px-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
            National Conference on <span className="text-blue-300">Computer Innovations</span>
          </h1>
          <p className="text-xl md:text-2xl text-white/90 mb-6">Exploring the Future of Technology and Innovation</p>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
            <div className="text-center">
              ...
              />
              <p className="font-medium text-gray-900">Kathmandu University Computer Club</p>
            </div>
            <div className="text-center">
              <Image
                src="/placeholder.svg?height=120&width=120"
                ...
                className="mx-auto mb-3"
              />
              <p className="font-medium text-gray-900">Department of Computer Science and Engineering</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container px-4 md:px-6">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Explore the Conference</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: <Users className="h-8 w-8" />,
                title: "About",
                description: "Learn about the conference objectives and significance",
              },
              {
                icon: <Users className="h-8 w-8" />,
                title: "Committee",
                description: "Meet our organizing and advisory committee members",
              },
              {
                icon: <FileText className="h-8 w-8" />,
                title: "Registration",
                description: "Register to participate in this prestigious event",
              },
              {
                icon: <FileText className="h-8 w-8" />,
                title: "Authors",
              ...
              >
                <div className="bg-blue-100 text-blue-700 p-3 rounded-full mb-4">{item.icon}</div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-800 to-purple-800 text-white">
        <div className="container px-4 md:px-6 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to be part of NCCI 2025?</h2>
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
            Join us for a day of innovation, learning, and networking with the brightest minds in computer science.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div>
              ...
              <p className="text-gray-600">Reach out to our team for any inquiries</p>
            </div>

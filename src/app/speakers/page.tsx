  ...
  return (
    <div className="container px-4 md:px-6 py-12">
      <div className="flex flex-col items-center text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">Keynote Speakers</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                expertise: ["Cybersecurity", "Quantum Computing", "Cryptography", "Network Security"],
              },
              {
                ...
                expertise: ["Cloud Computing", "Distributed Systems", "Virtualization", "Edge Computing"],
              },
              {
                ...
                expertise: ["Data Science", "Big Data Analytics", "Data Visualization", "Statistical Analysis"],
              },
            ].map((speaker, index) => (
              <Card key={index} className="overflow-hidden">
                ...
                <CardHeader className="text-center pt-4 pb-2">
                  ...
                  <CardDescription className="text-sm font-medium">{speaker.affiliation}</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="mb-4">
                    <h3 className="font-semibold text-blue-700">Keynote Topic</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-700 mb-2">Areas of Expertise</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                expertise: ["Quantum Algorithms", "Quantum Hardware", "Quantum Programming"],
              },
              {
              ...
              },
              {
                ...
                expertise: ["Threat Intelligence", "Network Security", "Malware Analysis"],
              },
              {
              ...
              <Card key={index} className="overflow-hidden">
                ...
                <CardHeader className="text-center pt-3 pb-2">
                  ...
                  <CardDescription className="text-xs">{speaker.title}</CardDescription>
                  <CardDescription className="text-xs font-medium">{speaker.affiliation}</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="mb-3">
                    <h3 className="text-sm font-semibold text-blue-700">Panel Topic</h3>
                    <p className="text-sm text-gray-800">{speaker.topic}</p>
                  </div>

                  <div>
                    <h3 className="text-sm font-semibold text-blue-700 mb-1">Expertise</h3>
      ...
      <div className="max-w-4xl mx-auto mt-12 bg-blue-50 p-6 rounded-lg">
        ...
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <h3 className="font-semibold text-lg">The Future of Computing: AI, Quantum, and Beyond</h3>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <h3 className="font-semibold text-lg">Cybersecurity Challenges in the Digital Age</h3>
            <p className="text-gray-600 mb-2">1:00 PM - 2:00 PM</p>
            <p className="text-gray-700">
              As digital technologies become increasingly integrated into our lives, this panel explores the evolving
              cybersecurity landscape and strategies to protect individuals, organizations, and critical infrastructure.
            </p>
          </div>

          <div className="bg-white p-4 rounded-lg shadow-sm">
            <h3 className="font-semibold text-lg">Innovation and Entrepreneurship in Tech</h3>
            ...
            <p className="text-gray-700">
              ...
              innovation, building tech startups, and navigating the challenges of the competitive technology market.
            </p>
          </div>
        </div>
      </div>
